  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        @media (max-width:1080px){#about .about-grid,#bot .bot-layout{grid-template-columns:1fr;}#about .signal-shell{min-height:850px;}#bot .program-shell{position:relative;inset:auto;margin:24px;min-height:540px;}#bot .bot-preview{min-height:auto;}}
