          ...
          <div className="hero-grid">
            ...
            <div className="hero-left reveal">
              <div className="hero-badge">
                ...
                실시간 시세차익 데이터 · 국내 데이터수집 종결
              </div>

              <h1 className="hero-title">
                거래소 간{" "}
                <span className="hero-grad">시세 차익</span>
                <br />
                한눈에, 빠르게!
                <span className="line2">국내 데이터수집의 새로운 기준</span>
              </h1>
      ...
      <section id="signal" style={{ padding: "100px 0" }}>
        <div className="container">
          <div className="section-head reveal">
            ...
            <p className="section-desc">
              복잡한 거래소 간 가격 비교를 자동화하여, 실제로 수익이 나는 순간만
              정확하게 포착합니다. 차트 분석 없이도 기회를 잡을 수 있습니다.
            </p>
          </div>
          ...
          <div className="feature-grid">
            <div className="feature-card reveal">
              ...
              <h3>실시간 데이터 수집</h3>
              <p>
                국내외 20개 이상의 거래소 호가를 초 단위로 수집합니다.
                오더북 기반의 실행 가능한 가격 데이터만 사용합니다.
              </p>
            </div>
            <div className="feature-card reveal reveal-delay-1">
              ...
              <h3>차익 자동 계산</h3>
              <p>
                수수료, 환율, 슬리피지를 모두 반영한 순수익 기준으로
                실행 가능한 아비트라지 기회만 선별합니다.
              </p>
            </div>
            <div className="feature-card reveal reveal-delay-2">
              ...
              <h3>텔레그램 시그널</h3>
              <p>
                조건에 맞는 기회가 발생하면 즉시 텔레그램으로 알림을 전송합니다.
                놓치는 기회 없이 프라이빗하게 관리됩니다.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="reveal reveal-delay-1">
              ...
              <div className="check-list">
                <div className="check-item">
                  국내/해외 모든 주요 거래소의 가격을 1초 단위로 비교
                </div>
                <div className="check-item">
                  테더(USDT) 환율 기반의 정확한 김프 계산 — 원달러 환율이 아닌 실질 수익 기준
                </div>
                <div className="check-item">
                  오더북 기반 실행 가능성 검증 — 뜨는 것이 아닌 실제 체결 가능한 기회만
                </div>
                <div className="check-item">
                  입출금 상태 실시간 모니터링 — 기회가 있을 때 바로 실행 가능한지 확인
                </div>
                <div className="check-item">
                  텔레그램 프라이빗 알림 — 나만의 조건으로 설정하는 맞춤 시그널
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="bot" className="bot-section">
        <div className="container">
          <div className="section-head center reveal">
            ...
            <h2 className="section-title">
              아비트라지(보따리)에<br />
              <span className="hero-grad">날개를 달아주는 BOT</span>
            </h2>
            <p className="section-desc">
              사용자 편의성을 최우선으로 고려한 보조 프로그램을 제공합니다.
              프라이빗한 텔레그램 알림부터 실전 흐름에 필요한 자동화 도구까지,
              실전에 바로 투입 가능한 솔루션입니다.
            </p>
          </div>
          ...
          <div className="bot-grid">
            <div className="bot-card reveal">
              ...
              <h3>실시간 시그널 알림 봇</h3>
              <p>
                설정한 조건에 맞는 아비트라지 기회가 발생하면 텔레그램으로
                즉시 알림을 전송합니다. 24시간 모니터링을 자동화합니다.
              </p>
            </div>
            <div className="bot-card reveal reveal-delay-1">
              ...
              <h3>실행 자동화 봇</h3>
              <p>
                시그널 발생 시 자동으로 매수/매도 주문을 실행합니다.
                반복 작업을 줄이고 판단과 리스크 관리에 집중할 수 있습니다.
              </p>
            </div>
            <div className="bot-card reveal reveal-delay-2">
              ...
              <h3>포트폴리오 모니터링 봇</h3>
              <p>
                보유 포지션과 수익률을 실시간으로 추적합니다.
                입출금 상태, 잔고 현황을 한눈에 파악할 수 있습니다.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="quote-contact-grid">
            ...
            <div className="quote-box reveal">
              <div className="quote-item">
                <strong>한국인이 달러를 직접 입출금하는 건 불법입니다.</strong>
                원달러 환율이 아비트라지에 무슨 의미가 있을까요?
                비트코인과 연동되는 <strong>테더(USDT) 환율</strong>만 보면 됩니다.
              </div>
              <div className="quote-item">
                아비트라지는 비트가 얼마 가고, 이더가 얼마 가고의 문제가 아닙니다.
                <strong>기본적 분석, 기술적 분석은 잊으세요.</strong>
                우리가 보여주는 그 자체만 보면 됩니다.
              </div>
              <div className="quote-item">
                주식·코인 경력 10년차가 지금까지 살아남은 비법,
                <strong>모든 것을 알려드립니다.</strong>
                하루 종일 차트 보면서 평단가에서 와리가리하는 스트레스,
                이제 그만 받으셔도 됩니다.
              </div>
              <div className="quote-item">
                데이트레이딩으로 끝낼 수 있는
                <strong>아비트라지의 매력에 빠져보세요.</strong>
              </div>
              <div className="quote-author">
                BODDARING · 아비트라지 전문가 그룹
              </div>
            </div>
