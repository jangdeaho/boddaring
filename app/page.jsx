  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        #about .signal-shell{position:relative;min-height:620px;overflow:hidden;border-radius:28px;border:1px solid rgba(255,255,255,.12);background:radial-gradient(420px 260px at 22% 18%,rgba(124,58,237,.18),transparent 62%),radial-gradient(420px 300px at 84% 20%,rgba(14,165,233,.11),transparent 65%),linear-gradient(145deg,rgba(255,255,255,.065),rgba(255,255,255,.026));box-shadow:0 24px 90px rgba(0,0,0,.42),inset 0 1px 0 rgba(255,255,255,.08);}
                ...
                <div className="program-shell">
                  ...
                  <div className="program-canvas"><div className="assist-preview-wrap">
                    ...
                    <div className="assist-slider-stage"><div className="assist-slider-track">
                      {[
                        ["🔎", "SEARCH", "컨트랙트 검색", "필요한 토큰 정보를 빠르게 확인하고, 핵심 주소를 바로 찾아볼 수 있는 검색형 프리셋입니다.", "Keyword", "USDT / ETH / XRP", "검색", "Explorer", "assist-pill-yellow", "assist-pill-blue"],
