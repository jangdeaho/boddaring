  ...
  const T = useMemo(() => {
    const dict = {
      ko: {
        ...
        disclaimerBody: ( 
          <> 
            BODDARING에서 제공되는 시장 데이터, 가격 정보, 계산 결과, 거래 내역, 수익 사례 및 기타 모든 정보는 
            이용자의 편의를 위한 <strong>참고용 정보</strong>이며, 특정 디지털 자산의 매수·매도 또는 보유를 권유하거나 
            투자판단을 제공하기 위한 것이 아닙니다.
            
            <br /><br />
            
            회사는 특정 디지털 자산에 대한 투자 또는 거래를 권유하거나, 특정 종목·가격·시점에 대한 매수·매도를 지시하거나, 
            이용자 개인의 투자 목적·재산 상태·투자성향 등을 고려한 개별적인 투자자문을 제공하지 않습니다.
            
            <br /><br />
            
            서비스 또는 회사가 운영하는 웹사이트, 커뮤니티, 텔레그램 채널 등에 게시되는 거래 내역 및 수익 사례는 
            실제 또는 과거에 이루어진 거래 결과를 기록하거나 서비스 활용 사례를 안내하기 위한 것입니다.
            
            <br /><br />
            
            해당 거래 내역, 수익률 및 수익 사례는 동일한 거래를 권유하거나 따라 하도록 유도하기 위한 것이 아니며, 
            <strong>향후 동일하거나 유사한 결과 또는 수익이 발생할 것을 의미하거나 보장하지 않습니다.</strong>
            
            <br /><br />
            
            회사는 어떠한 경우에도 투자 원금, 손실 보전, 최소 수익 또는 일정한 수익률을 보장하지 않습니다.
            
            <br /><br />
            
            디지털 자산 거래는 높은 가격 변동성과 원금 손실의 위험을 수반하며, 시장 상황, 거래소 간 가격 차이, 
            거래량 및 유동성, 체결 지연, 슬리피지, 거래 및 출금 수수료, 입출금 제한, 거래소 정책 변경, 
            네트워크 혼잡·장애 및 기타 예상할 수 없는 요인으로 인해 표시된 정보 또는 과거 거래 사례와 실제 거래 결과가 달라질 수 있습니다.
            
            <br /><br />
            
            또한 서비스에서 제공되는 데이터는 거래소의 공개 API, 공개 데이터 또는 제3자가 제공하는 정보를 기반으로 할 수 있으므로 
            회사는 해당 정보의 정확성·완전성·적시성·실시간성 또는 지속적인 제공을 보장하지 않습니다.
            
            <br /><br />
            
            이용자는 서비스에서 제공되는 정보 또는 다른 이용자의 거래 사례만을 근거로 거래 여부를 결정해서는 안 되며, 
            모든 거래에 대한 최종 판단은 이용자 본인이 독립적으로 내려야 합니다.
            
            <br /><br />
            
            <strong>
              모든 투자 및 거래에 대한 최종 의사결정과 그에 따른 이익 또는 손실은 이용자 본인에게 귀속됩니다.
            </strong>
          </> 
        ),
